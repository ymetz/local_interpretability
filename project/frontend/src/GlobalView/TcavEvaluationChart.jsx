...
export default class TcavEvaluationChart extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.experimentData !== undefined) {
      this.draw(this.props.experimentData);
    }
  }
  ...
  draw = (props) => {
    ...
    svg.append("rect")
      ...
      .attr("class", "concept-g")
          .selectAll(".class_g").data(d => Object.values(d)).enter().append("g");
      ...
      if (props.exp_info.name === 'wordnet correlation scores') {
        ...
        data_g.selectAll(".ls-random-line").data(d => d).enter().append("line")
            ...
            .attr("x1", d => x(d.concept)+class_width*(class_list.indexOf(d.class)+1))
            .attr("x2", d => x(d.concept)+class_width*(class_list.indexOf(d.class)+1))
        ...
        data_g
            ...
            .attr("stroke", d => ((d[0].score - d[1].score) < 0.0) ? "#a3f441" : "#f44941")
