...
class TCAV(object):
  ...
  def __init__(self,
    ...
    self.sess = sess
    self.use_numeric_class_label = use_numeric_class_label
  ...
  def _run_single_set(self, param):
    ...
    if self.use_numeric_class_label:
        ...
        in_target_class = str(target_class) if self.use_numeric_class_label else target_class
    ...
    if self.use_numeric_class_label:
        ...
        target_class_for_compute_tcav_score = mymodel.label_to_id(target_class) + 1
    ...
    for cav_concept in concepts:
        if cav_concept is self.random_counterpart or 'random500' not in cav_concept:
            i_up = self.compute_tcav_score(
                ...
                cav_instance, acts[str(target_class)][cav_instance.bottleneck],)
